...
module.exports = {
    ...
    themeConfig: {
        ...
        announcementBar: {
            ...
            isCloseable: true,
            content: 'If you would like to contribute, give it a star on <a target="_blank" rel="noopener noreferrer" href="https://github.com/moja-global/community-website">GitHub</a> ⭐ and take a look at the open issues!',
        },
        colorMode: {
            defaultMode: 'dark',
            switchConfig: {
