...
It also uses a special turnover rate for various pools like carotelm pool. It sets the turnover rate for different pools by taking into account the values of various GHG.
